...
http://www.netapp.com/us/media/tr-3966.pdf["Report tecnico NetApp 3966: Guida all'implementazione e all'implementazione della compressione e deduplica dei dati NetApp (Clustered Data ONTAP)"]
